...
export declare const calculateL1GasFeesHelper: (route: RouteWithValidQuote[], chainId: ChainId, usdPool: Pair | Pool, quoteToken: Token, nativePool: Pair | Pool | null, l2GasData?: ArbitrumGasData | OptimismGasData) => Promise<{
    gasUsedL1: BigNumber;
